package xyz.semoteo.ready.mod.impl;
...
public class RenderMethods {
  ...
  public static void draw2D(Entity e, double posX, double posY, double posZ, int color) {
    ...
    drawDarkOutlineRect(-5.3F, -20.1F, 5.3F, 2.1F, -16777216);
    drawDarkOutlineRect(-5.0F, -19.8F, 5.0F, 1.8F, -16777216);
  ...
  public static void drawIcon(ResourceLocation res, double x, double y, float u, float v, double width, double height, float textureWidth, float textureHeight) {
    GlStateManager.pushMatrix();
    Minecraft.getMinecraft().getTextureManager().bindTexture(res);
    GlStateManager.translate(x, y + 3.0D, 0.0D);
  ...
  public static void rectangle(double left, double top, double right, double bottom, int color) {
    ...
    float var7 = (color >> 16 & 0xFF) / 255.0F;
    float var8 = (color >> 8 & 0xFF) / 255.0F;
    float var9 = (color & 0xFF) / 255.0F;
