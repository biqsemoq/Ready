...
{
    private static final Pattern PATTERN_DEFINE = Pattern.compile("^\\s*(// BAKMASANA KODLARA AMK
    ...
    {
        return isTrue(this.getValue()) ? "#define " + this.getName() + " // BAKMASANA KODLARA AMK
    }
    ...
    public static ShaderOption parseOption(String line, String path)
    {
        ...
        else
        {
            ...
            {
                boolean commented = Config.equals(comment, "// BAKMASANA KODLARA AMK
