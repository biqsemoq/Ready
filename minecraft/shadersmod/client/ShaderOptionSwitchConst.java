...
{
    private static final Pattern PATTERN_CONST = Pattern.compile("^\\s*const\\s*bool\\s*([A-Za-z0-9_]+)\\s*=\\s*(true|false)\\s*;\\s*(// BAKMASANA KODLARA AMK
    ...
    {
        return "const bool " + this.getName() + " = " + this.getValue() + "; // BAKMASANA KODLARA AMK
    }
