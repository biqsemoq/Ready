...
{
    private static final Pattern PATTERN_VARIABLE = Pattern.compile("^\\s*#define\\s+([A-Za-z0-9_]+)\\s+(-?[0-9\\.]*)F?f?\\s*(// BAKMASANA KODLARA AMK
    ...
    {
        return "#define " + this.getName() + " " + this.getValue() + " // BAKMASANA KODLARA AMK
    }
